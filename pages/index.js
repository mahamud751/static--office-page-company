          ...
          >
            <div className="col-md-7">
              <div className="intro_text white-text">
                <h1 className="text-dark" style={{ fontSize: 54 }}>
                  <span style={{ color: "#0554F2" }}>WE BUILT</span> CAREFULLY
                  AND THROUGHLY FOR YOUR BUSINESS
                </h1>
                <p className="text-dark fw-normal">
                  We are highly focused on developing transparent codes with
                  proper notes that are very easy to manage and edit. Our
                  complete software projects will help you to start your
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 px-lg-5">
              ...
              <p className="mt-5">
                <span style={{ color: "#0554F2" }}>Web Touch LTD</span> is a
                Software and Website Development Company in Bangladesh that
